'use strict';
// lib/aria.js — the ONE shared parser for agent-browser's ARIA snapshot tree (the indented YAML-ish
// a11y dump). Used by every extractor (bin/extract-approvals.js, extract-list.js, extract-detail.js,
// propose-recipe.js) so the line tokenizer + container/row walk + text helpers live in a single leaf
// (DRY: a guard/parse fix is made once, not mirrored by hand across four files). Pure; no deps.
