...
fresh resolver evidence generation: PASS for 15 approved hosts
...
## Approved Origin Set Used

The clean replay used the same read-only origin set listed in
`HIWORKS-READONLY-OWNER-APPROVAL-REQUEST-2026-06-11.md`. Raw resolver and connection-IP evidence were
generated freshly for the run but are not included here.
...
- raw resolver or connection-IP evidence unless separately owner-approved and redacted
